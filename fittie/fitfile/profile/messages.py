########################################################################################
#   This file is auto generated at 2025-03-30 13:37:13.198070, do not edit this file   #
########################################################################################
MESSAGES = {
    0: {
        "name": "file_id",
    ...
    18: {
        ...
        "fields": {
            ...
            192: {
                ...
                "accumulate": None,
                "subfields": [],
                "comment": "A 0-100 scale representing how a user felt while "
                "performing a workout. Low values are considered "
                "feeling bad, while high values are good.",
            },
            193: {
                ...
                "accumulate": None,
                "subfields": [],
                "comment": "Common Borg CR10 / 0-10 RPE scale, multiplied 10x.. "
                "Aggregate score for all workouts in a single "
                "session.",
            },
            194: {
                "field_name": "avg_spo2",
            ...
            197: {
                ...
                "accumulate": None,
                "subfields": [],
                "comment": "Standard deviation of R-R interval (SDRR) - Heart "
                "rate variability measure most useful for wellness "
                "users.",
            },
            198: {
                ...
                "accumulate": None,
                "subfields": [],
                "comment": "Root mean square successive difference (RMSSD) - "
                "Heart rate variability measure most useful for "
                "athletes",
            },
            199: {
    ...
    20: {
        ...
        "fields": {
            ...
            87: {
                ...
                "accumulate": None,
                "subfields": [],
                "comment": "Supports larger cycle sizes needed for paddlesports. "
                "Max cycle size: 655.35",
            },
            91: {
    ...
    21: {
        ...
        "fields": {
            ...
            14: {
                ...
                "accumulate": None,
                "subfields": [],
                "comment": "Activity Type associated with an "
                "auto_activity_detect event",
            },
            15: {
    ...
    229: {
        ...
        "fields": {
            ...
            9: {
                ...
                "accumulate": None,
                "subfields": [],
                "comment": "Indicates if calibrated data was used in the "
                "calculation",
            },
            12: {
                ...
                "accumulate": None,
                "subfields": [],
                "comment": "Indicates if the estimate was obtained using a "
                "chest strap or wrist heart rate",
            },
            13: {
                "field_name": "speed_source",
                ...
                "accumulate": None,
                "subfields": [],
                "comment": "Indidcates if the estimate was obtained using "
                "onboard GPS or connected GPS",
            },
        },
        "group": "MONITORING FILE MESSAGES",
    },
    ...
    304: {
        ...
        "fields": {
            ...
            0: {
                ...
                "accumulate": None,
                "subfields": [],
                "comment": "Processing interval length in seconds. File start: "
                "0xFFFFFFEF File stop: 0xFFFFFFEE",
            },
            1: {
                "field_name": "steps",
                "field_type": "uint32",
    ...
    306: {
        ...
        "fields": {
            ...
            1: {
                ...
                "accumulate": None,
                "subfields": [],
                "comment": "Stress Level: [0,100] Off wrist: -1 Excess motion: "
                "-2 Not enough data: -3 Recovering from exercise: -4 "
                "Unidentified: -5 Blank: -16",
            },
        },
        "group": "MONITORING FILE MESSAGES",
    },
    307: {
        ...
        "fields": {
            ...
            1: {
                ...
                "accumulate": None,
                "subfields": [],
                "comment": "Breaths / min: [1,100] Invalid: 255 Excess motion: "
                "254 Off wrist: 253 Not available: 252 Blank: 2.4",
            },
        },
        "group": "MONITORING FILE MESSAGES",
    },
    308: {
        ...
        "fields": {
            ...
            1: {
                ...
                "accumulate": None,
                "subfields": [],
                "comment": "Status of measurements in buffer - 0 indicates "
                "SEARCHING 1 indicates LOCKED",
            },
            2: {
                "field_name": "heart_rate",
                "field_type": "uint8",
    ...
    289: {
        ...
        "fields": {
            ...
            4: {
                ...
                "accumulate": None,
                "subfields": [],
                "comment": "Total accelerometer time above threshold in the "
                "interval",
            },
        },
        "group": "OTHER MESSAGES",
    ...
    372: {
        ...
        "fields": {
            ...
            1: {
                ...
                "accumulate": None,
                "subfields": [],
                "comment": "1 bit for gap indicator, 1 bit for quality "
                "indicator, and 14 bits for Beat-to-Beat interval "
                "values in whole-integer millisecond resolution",
            },
            2: {
                "field_name": "time",
                "field_type": "uint16",
            ...
            3: {
                ...
                "accumulate": None,
                "subfields": [],
                "comment": "1 = high confidence. 0 = low confidence. N/A when "
                "gap = 1",
            },
            4: {
                "field_name": "gap",
    ...
    297: {
        ...
        "fields": {
            ...
            0: {
                ...
                "accumulate": None,
                "subfields": [],
                "comment": "Breaths * 100 /min, -300 indicates invalid, -200 "
                "indicates large motion, -100 indicates off wrist",
            },
        },
        "group": "OTHER MESSAGES",
    },
    ...
    346: {
        ...
        "fields": {
            0: {
                ...
                "awakenings_count_score. If valid: 0 (worst) to 100 "
                "(best). If unknown: FIT_UINT8_INVALID.",
            },
            1: {
                ...
                "accumulate": None,
                "subfields": [],
                "comment": "Score that evaluates the total time spent awake "
                "between sleep. If valid: 0 (worst) to 100 (best). If "
            ...
            2: {
                ...
                "accumulate": None,
                "subfields": [],
                "comment": "Score that evaluates the number of awakenings that "
                "interrupt sleep. If valid: 0 (worst) to 100 (best). "
            ...
            3: {
                ...
                "accumulate": None,
                "subfields": [],
                "comment": "Score that evaluates the amount of deep sleep. If "
                "valid: 0 (worst) to 100 (best). If unknown: "
                "FIT_UINT8_INVALID.",
            },
            4: {
                ...
                "accumulate": None,
                "subfields": [],
                "comment": "Score that evaluates the quality of sleep based on "
                "sleep stages, heart-rate variability and possible "
                "awakenings during the night. If valid: 0 (worst) to "
                "100 (best). If unknown: FIT_UINT8_INVALID.",
            },
            5: {
                ...
                "accumulate": None,
                "subfields": [],
                "comment": "Score that evaluates the amount of light sleep. If "
                "valid: 0 (worst) to 100 (best). If unknown: "
                "FIT_UINT8_INVALID.",
            },
            6: {
                ...
                "accumulate": None,
                "subfields": [],
                "comment": "Total score that summarizes the overall quality of "
                "sleep, combining sleep duration and quality. If "
                "valid: 0 (worst) to 100 (best). If unknown: "
                "FIT_UINT8_INVALID.",
            },
            7: {
            ...
            8: {
                ...
                "accumulate": None,
                "subfields": [],
                "comment": "Score that evaluates stress and recovery during "
                "sleep. If valid: 0 (worst) to 100 (best). If "
                "unknown: FIT_UINT8_INVALID.",
            },
            9: {
                ...
                "accumulate": None,
                "subfields": [],
                "comment": "Score that evaluates the amount of REM sleep. If "
                "valid: 0 (worst) to 100 (best). If unknown: "
                "FIT_UINT8_INVALID.",
            },
            10: {
                ...
                "accumulate": None,
                "subfields": [],
                "comment": "Score that evaluates the amount of restlessness "
                "during sleep. If valid: 0 (worst) to 100 (best). If "
                "unknown: FIT_UINT8_INVALID.",
            },
            11: {
            ...
            14: {
                ...
                "accumulate": None,
                "subfields": [],
                "comment": "Score that evaluates the sleep interruptions. If "
                "valid: 0 (worst) to 100 (best). If unknown: "
                "FIT_UINT8_INVALID.",
            },
            15: {
                ...
                "accumulate": None,
                "subfields": [],
                "comment": "Excludes stress during awake periods in the sleep "
                "window",
            },
        },
        "group": "OTHER MESSAGES",
    ...
    398: {
        ...
        "fields": {
            ...
            1: {
                ...
                "accumulate": None,
                "subfields": [],
                "comment": "The average overnight deviation from baseline "
            ...
            2: {
                ...
                "accumulate": None,
                "subfields": [],
                "comment": "The average 7 day overnight deviation from baseline "
                "temperature in degrees C",
            },
            4: {
